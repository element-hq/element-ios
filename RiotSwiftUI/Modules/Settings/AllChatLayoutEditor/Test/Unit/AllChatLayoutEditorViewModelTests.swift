...
class AllChatLayoutEditorViewModelTests: XCTestCase {
    ...
    var service: MockAllChatLayoutEditorService!
    var viewModel: AllChatLayoutEditorViewModelProtocol!
    var context: AllChatLayoutEditorViewModelType.Context!
    var cancellables = Set<AnyCancellable>()
    override func setUpWithError() throws {
        service = MockAllChatLayoutEditorService(displayName: Constants.displayName, presence: Constants.presenceInitialValue)
        viewModel = AllChatLayoutEditorViewModel.makeAllChatLayoutEditorViewModel(allChatLayoutEditorService: service)
    ...
    func testPresenceUpdatesReceived() throws {
        ...
        let newPresenceValue1: AllChatLayoutEditorPresence = .online
        let newPresenceValue2: AllChatLayoutEditorPresence = .idle
