...
@available(iOS 14.0, *)
class SpaceSelectorBottomSheetViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        service = MockSpaceSelectorBottomSheetService(displayName: Constants.displayName, presence: Constants.presenceInitialValue)
        viewModel = SpaceSelectorBottomSheetViewModel.makeSpaceSelectorBottomSheetViewModel(spaceSelectorBottomSheetService: service)
