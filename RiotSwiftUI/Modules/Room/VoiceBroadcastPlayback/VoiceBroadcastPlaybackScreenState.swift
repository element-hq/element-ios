...
enum MockVoiceBroadcastPlaybackScreenState: MockScreenState, CaseIterable {
    ...
    var screenView: ([Any], AnyView) {
        ...
        let viewModel = MockVoiceBroadcastPlaybackViewModel(initialViewState: VoiceBroadcastPlaybackViewState(details: details, broadcastState: .live,  playbackState: .stopped, playingState: VoiceBroadcastPlayingState(duration: 10.0, position: 5.0), bindings: VoiceBroadcastPlaybackViewStateBindings()))
