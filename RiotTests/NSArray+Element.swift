...
class NSArray_Element: XCTestCase {
    var array = NSArray() //  will contain strings
    ...
    func testCompactMap() throws {
        // This is an example of a functional test case.
        // Use XCTAssert and related functions to verify your tests produce the correct results.
        let nilMapped: [Any] = array.vc_compactMap { _ in
            nil
        }
    ...
    func testFlatMap() throws {
        // This is an example of a functional test case.
        // Use XCTAssert and related functions to verify your tests produce the correct results.
        let emptyMapped: [Any] = array.vc_flatMap { _ in
            []
        }
        ...
        let constantMapped: [Any] = array.vc_flatMap { _ in
            [1, 2]
        }
