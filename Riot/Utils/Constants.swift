...
class Constants: NSObject {
    ...
    static let userInfoKeyPresentNotificationOnForeground = "ALWAYS_PRESENT_NOTIFICATION"
    ...
    static let userInfoKeyPresentNotificationInRoom = "IN_ROOM_PRESENT_NOTIFICATION"
}
