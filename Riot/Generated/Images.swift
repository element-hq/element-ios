...
internal class Asset: NSObject {
  ...
  @objc(AssetImages) internal class Images: NSObject {
    ...
    internal static let voiceBroadcastPauseButton = ImageAsset(name: "voice_broadcast_pause_button")
    internal static let voiceBroadcastRecordButton = ImageAsset(name: "voice_broadcast_record_button")
    internal static let voiceBroadcastStopButton = ImageAsset(name: "voice_broadcast_stop_button")
