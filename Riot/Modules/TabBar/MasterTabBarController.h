...
- (void)masterTabBarController:(MasterTabBarController *)masterTabBarController shouldPresentAnalyticsPromptAsUpgrade:(BOOL)isUpgradePrompt forMatrixSession:(MXSession*)matrixSession;
