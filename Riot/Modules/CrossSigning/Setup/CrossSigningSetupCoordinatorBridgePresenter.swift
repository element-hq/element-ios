...
final class CrossSigningSetupCoordinatorBridgePresenter: NSObject {
    ...
    func present(with title: String,
        ...
        let parameters = CrossSigningSetupCoordinatorParameters(session: session, presenter: viewController, title: title, message: message)
        ...
        coordinator = crossSigningSetupCoordinator
    }
