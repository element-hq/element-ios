...
class AllChatsActionProvider {
    ...
    private var recentsAction: UIAction {
        UIAction(title: VectorL10n.allChatsEditLayoutShowRecents,
    ...
    private var filtersAction: UIAction {
        UIAction(title: VectorL10n.allChatsEditLayoutShowFilters,
    ...
    private var activityOrderAction: UIAction {
        UIAction(title: VectorL10n.allChatsEditLayoutActivityOrder,
                 state: AllChatsLayoutSettingsManager.shared.allChatLayoutSettings.sorting == .activity ? .on : .off) { _ in
            let settings = AllChatsLayoutSettingsManager.shared.allChatLayoutSettings
            let newSettings = AllChatsLayoutSettings(sections: settings.sections,
                                                     filters: settings.filters,
                                                     sorting: .activity)
    ...
    private var alphabeticalOrderAction: UIAction {
        UIAction(title: VectorL10n.allChatsEditLayoutAlphabeticalOrder,
                 state: AllChatsLayoutSettingsManager.shared.allChatLayoutSettings.sorting == .alphabetical ? .on : .off) { _ in
            let settings = AllChatsLayoutSettingsManager.shared.allChatLayoutSettings
            let newSettings = AllChatsLayoutSettings(sections: settings.sections,
                                                     filters: settings.filters,
