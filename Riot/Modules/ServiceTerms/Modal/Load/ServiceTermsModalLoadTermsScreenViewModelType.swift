...
protocol ServiceTermsModalLoadTermsScreenViewModelViewDelegate: class {
...
protocol ServiceTermsModalLoadTermsScreenViewModelCoordinatorDelegate: class {
...
/// Protocol describing the view model used by `ServiceTermsModalLoadTermsScreenViewController`
protocol ServiceTermsModalLoadTermsScreenViewModelType {
        
    var viewDelegate: ServiceTermsModalLoadTermsScreenViewModelViewDelegate? { get set }
    var coordinatorDelegate: ServiceTermsModalLoadTermsScreenViewModelCoordinatorDelegate? { get set }
