...
@objc protocol ServiceTermsModalCoordinatorBridgePresenterDelegate {
    ...
    func serviceTermsModalCoordinatorBridgePresenterDelegateDidDecline(_ coordinatorBridgePresenter: ServiceTermsModalCoordinatorBridgePresenter)
    func serviceTermsModalCoordinatorBridgePresenterDelegateDidFail(_ coordinatorBridgePresenter: ServiceTermsModalCoordinatorBridgePresenter, error: NSError)
...
extension ServiceTermsModalCoordinatorBridgePresenter: ServiceTermsModalCoordinatorDelegate {
    ...
    func serviceTermsModalCoordinatorDidDecline(_ coordinator: ServiceTermsModalCoordinatorType) {
        self.delegate?.serviceTermsModalCoordinatorBridgePresenterDelegateDidDecline(self)
    }

    func serviceTermsModalCoordinatorDidFail(_ coordinator: ServiceTermsModalCoordinatorType, error: NSError) {
        self.delegate?.serviceTermsModalCoordinatorBridgePresenterDelegateDidFail(self, error: error)
    }
