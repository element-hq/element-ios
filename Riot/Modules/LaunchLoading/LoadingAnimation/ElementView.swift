...
public class ElementView: UIView {
    public struct Defaults {
        ...
        public static let accentColor = ThemeService.shared().theme.colors.accent
    }
    ...
    private func createPath() {
        ...
        path.shapeLayer.fillColor = Defaults.accentColor.cgColor
    ...
    private func createPath1() {
        ...
        path_1.shapeLayer.fillColor = Defaults.accentColor.cgColor
    ...
    private func createPath2() {
        ...
        path_2.shapeLayer.fillColor = Defaults.accentColor.cgColor
    ...
    private func createPath3() {
        ...
        path_3.shapeLayer.fillColor = Defaults.accentColor.cgColor
