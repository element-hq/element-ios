...
- (void)pageController:(WMPageController *)pageController didSelectedMenu:(WMMenuView *)menu atIndex:(NSInteger)index;

- (void)pageController:(WMPageController *)pageController didScrollToMenuItemAtIndex:(NSInteger)index;

- (void)pageController:(WMPageController *)pageController willLeaveViewController:(UIViewController *)viewController atIndex:(NSInteger)index;
