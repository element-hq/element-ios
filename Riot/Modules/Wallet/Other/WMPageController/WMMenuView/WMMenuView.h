...
- (WMMenuItem *)menuView:(WMMenuView *)menu menuItemForIndex:(NSInteger)index;
...
/** 是否显示Menu线条 */
@property (nonatomic, assign) BOOL showMenuLine;
@property (nonatomic, strong) UIColor *menuLineColor;
