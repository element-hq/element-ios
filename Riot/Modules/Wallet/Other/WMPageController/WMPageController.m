...
- (void)wm_removeViewController:(UIViewController *)viewController atIndex:(NSInteger)index {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pageController:willLeaveViewController:atIndex:)]) {
        [self.delegate pageController:self willLeaveViewController:viewController atIndex:index];
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pageController:didScrollToMenuItemAtIndex:)]) {
        [self.delegate pageController:self didScrollToMenuItemAtIndex:_selectIndex];
    }
}
...
- (void)menuView:(WMMenuView *)menu didSelectedIndex:(NSInteger)index currentIndex:(NSInteger)currentIndex {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(pageController:didSelectedMenu:atIndex:)]) {
        [self.delegate pageController:self didSelectedMenu:menu atIndex:index];
    }
}
