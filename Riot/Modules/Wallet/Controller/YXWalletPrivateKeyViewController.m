//
//  YXWalletPrivateKeyViewController.m
//  lianliao
//
...
@interface YXWalletPrivateKeyViewController ()
...
-(YXWalletPrivatekeyViewModel *)viewModel{
    if (!_viewModel) {
        _viewModel = [[YXWalletPrivatekeyViewModel alloc]init];
        YXWeakSelf
...
- (void)viewDidLoad {
    ...
    self.proxy.viewModel = self.viewModel;
