...
/**
 UserEncryptionTrustLevel represents the user trust level in a room.
 */
typedef NS_ENUM(NSUInteger, UserEncryptionTrustLevel) {
    ...
    UserEncryptionTrustLevelNone,               // Crypto is not enabled. Should not happen. Possible if the room is non-e2ee.
