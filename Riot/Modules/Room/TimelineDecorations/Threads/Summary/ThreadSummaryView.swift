...
class ThreadSummaryView: UIView {
    ...
    @IBOutlet private var numberOfRepliesLabel: UILabel!
    @IBOutlet private var lastMessageAvatarView: UserAvatarView!
    @IBOutlet private var lastMessageContentLabel: UILabel!
    ...
    static func contentViewHeight(forThread thread: MXThreadProtocol?, fitting maxWidth: CGFloat) -> CGFloat {
        PlainRoomCellLayoutConstants.threadSummaryViewHeight
    }
