...
final class RoomCreationEventsModalViewController: UIViewController {
    ...
    @IBOutlet private var roomAvatarImageView: MXKImageView! {
        didSet {
            roomAvatarImageView.layer.cornerRadius = roomAvatarImageView.frame.width / 2
        }
    }

    @IBOutlet private var encryptionIconImageView: UIImageView!
    @IBOutlet private var roomNameLabel: UILabel!
    @IBOutlet private var roomInfoLabel: UILabel!
...
extension RoomCreationEventsModalViewController: SlidingModalPresentable {
    ...
    func layoutHeightFittingWidth(_ width: CGFloat) -> CGFloat {
        mainTableView.contentSize.height
